	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<p class="navbar-brand">Quản lí bài đăng</p>
			</div>							
		</div><!-- /.container-fluid -->
	</nav>
					...
					<div class="panel-body">
						<table data-toggle="table" data-url="tables/data1.json"  data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						        ...
						        <td><a href="user_edit_baidang.html">Sửa </a>-<a> Xóa</a></td>
						    </tr>
						</table>
					</div>
					<div class="panel-body" align="right"><a href="user_add_baidang.html">Thêm bài đăng</a></div>
				</div>
			</div>
		</div><!--/.row-->	
	</div><!--/.main-->
