        ...
        <footer>
            <div class="container">
                <div class="row">
                    <div class="col col-sm-3">
                        <div class="widget latest-news">
                            ...
                            <ul>
                                ...
                                <li><a href="#">Phasellus dapibus dictum augue, ut</a></li>
                                <li><a href="#">Mauris blandit vitae. Praesent non mi</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col col-sm-6">
                        <div class="widget about-widget">
                            <h3>About us</h3>
                            <div class="logo"><img src="<%=request.getContextPath() %>/templates/public/images/logo.png" alt class="img img-responsive"></div>
                            <p>Nulla facilisi. Nulla fringilla risus urna, ut sollicitudin lorem rutrum quis. Nunc in auctor turpis. Cras ut ligula leo. Lorem ipsum dolor sit amet,consectetur adipiscing elit. </p>
                            <div class="follow-us">
                                <span>Follow us: </span>
                                <ul>
                ...
                <div class="row copyright">
                    <p>Copyright &copy; 2016 <a href="#">wpthemeshaper.</a> All Rights Reserved</p>
                </div>
            </div> <!-- end container -->
        </footer>
        <!-- end footer -->
