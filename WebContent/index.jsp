        ...
        <section class="project-gallery section-padding parallax gallery-popup" data-bg-image="images/project-gallery/project-gallery-bg.jpg">
            <div>
                ...
                <div class="project-gallery-slider">
                    <div class="item">
                        <div class="box">
                            <a href="<%=request.getContextPath()%>/templates/public/images/project-gallery/big-photo/img-1.jpg">
                                <div class="img-holder">
                    ...
                    <div class="item">
                        <div class="box">
                            <a href="<%=request.getContextPath()%>/templates/public/images/project-gallery/big-photo/img-2.jpg">
                                <div class="img-holder">
                    ...
                    <div class="item">
                        <div class="box">
                            <a href="<%=request.getContextPath()%>/templates/public/images/project-gallery/big-photo/img-3.jpg">
                                <div class="img-holder">
                    ...
                    <div class="item">
                        <div class="box">
                            <a href="<%=request.getContextPath()%>/templates/public/images/project-gallery/big-photo/img-4.jpg">
                                <div class="img-holder">
                    ...
                    <div class="item">
                        <div class="box">
                            <a href="<%=request.getContextPath()%>/templates/public/images/project-gallery/big-photo/img-5.jpg">
                                <div class="img-holder">
                    ...
                    <div class="item">
                        <div class="box">
                            <a href="<%=request.getContextPath()%>/templates/public/images/project-gallery/big-photo/img-6.jpg">
                                <div class="img-holder">
                                    <img src="<%=request.getContextPath()%>/templates/public/images/project-gallery/img-2.jpg" alt class="img img-responsive">
                                </div>
                                <div class="hover-text">
                    ...
                    <div class="item">
                        <div class="box">
                            <a href="<%=request.getContextPath()%>/templates/public/images/project-gallery/big-photo/img-7.jpg">
                                <div class="img-holder">
                                    <img src="<%=request.getContextPath()%>/templates/public/images/project-gallery/img-1.jpg" alt class="img img-responsive">
                                </div>
                                <div class="hover-text">
