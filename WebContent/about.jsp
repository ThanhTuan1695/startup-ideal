                ...
                <div class="row">
                        ...
                        <div class="text-with-gallery">
                            ...
                            <div class="sm-service-gallery">
                                <div class="box">
                                    <a href="#">
                                        <div class="img-holder">
                                            <img src="images/about/about-gallery/img-1.jpg" alt="" class="img img-responsive">
                                        </div>
                                ...
                                <div class="box">
                                    <a href="#">
                                        <div class="img-holder">
                                            <img src="images/about/about-gallery/img-2.jpg" alt="" class="img img-responsive">
                                        </div>
                                        <div class="hover-text">
                                            <h6>Garden Care &amp; Maintenance</h6>
                                        </div>
                                ...
                                <div class="box">
                                    <a href="#">
                                        <div class="img-holder">
                                            <img src="images/about/about-gallery/img-3.jpg" alt="" class="img img-responsive">
                                        </div>
                                        <div class="hover-text">
                                            <h6>Garden Care &amp; Maintenance</h6>
                                        </div>
                                ...
                                <div class="box">
                                    <a href="#">
                                        <div class="img-holder">
                                            <img src="images/about/about-gallery/img-4.jpg" alt="" class="img img-responsive">
                                        </div>
                                        <div class="hover-text">
                                            <h6>Garden Care &amp; Maintenance</h6>
                                        </div>
                    ...
                    <div class="col col-md-6 about-big-photo-wrapper wow fadeInRightSlow" style="visibility: visible; animation-name: fadeInRightSlow;">
                        ...
                        <div class="about-big-photo">
                            <img src="images/about/about-big-photo.png" alt="" class="img img-responsive">
                        </div>
                    </div>
                </div>
                ...
                <div class="row fun-fact">
                    <div class="col col-sm-3 col-xs-6">
                        <div class="box">
                            ...
                            <img src="images/funfact-icon.png" alt="" class="img img-responsive">
            ...
            <div class="container">
                ...
                <div class="row content">
                    <div class="col col-md-4 wow fadeInLeftSlow">
                        <div class="box">
                            <div class="img-holder">
                                <img src="images/featured-services/img-1.jpg" alt class="img img-responsive">
                            </div>
                            <div class="details">
                    ...
                    <div class="col col-md-4 wow fadeInLeftSlow" data-wow-delay="0.3s">
                        <div class="box">
                            <div class="img-holder">
                                <img src="images/featured-services/img-2.jpg" alt class="img img-responsive">
                            </div>
                            <div class="details">
                    ...
                    <div class="col col-md-4 wow fadeInLeftSlow" data-wow-delay="0.6s">
                        <div class="box">
                            <div class="img-holder">
                                <img src="images/featured-services/img-3.jpg" alt class="img img-responsive">
                            </div>
                            <div class="details">
                ...
                <div class="row">
                    <div class="col col-sm-6 left-col">
                        <div class="top-img-holder">
                            <img src="images/cta/img-1.jpg" alt class="wow bounceInUp" data-wow-delay="0.6s">
                        </div>
                        <div class="bottom-img-holder">
                            <img src="images/cta/img-2.jpg" alt>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col col-sm-4">
                        <div class="member wow slideInUpSlow" data-wow-delay="0.3s">
                            <div class="img-holder">
                                <img src="images/team/img-1.jpg" alt class="img img-responsive">
                            </div>
                            <div class="details">
                    ...
                    <div class="col col-sm-4">
                        <div class="member wow slideInUpSlow" data-wow-delay="0.6s">
                            <div class="img-holder">
                                <img src="images/team/img-2.jpg" alt class="img img-responsive">
                            </div>
                            <div class="details">
                                <h3>Maria pattra</h3>
                                <span>Founder</span>
                    ...
                    <div class="col col-sm-4">
                        <div class="member wow slideInUpSlow" data-wow-delay="0.9s">
                            <div class="img-holder">
                                <img src="images/team/img-3.jpg" alt class="img img-responsive">
                            </div>
                            <div class="details">
                                <h3>Maria pattra</h3>
                                <span>Founder</span>
        ...
        <section class="partner section-padding">
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="box">
                            <a href="#"><img src="images/partner/img-1.png" alt class="img img-responsive"></a>
                        </div>
                        <div class="box">
                            <a href="#"><img src="images/partner/img-2.png" alt class="img img-responsive"></a>
                        </div>
                        <div class="box">
                            <a href="#"><img src="images/partner/img-3.png" alt class="img img-responsive"></a>
                        </div>
                        <div class="box">
                            <a href="#"><img src="images/partner/img-4.png" alt class="img img-responsive"></a>
                        </div>
                        <div class="box">
                            <a href="#"><img src="images/partner/img-5.png" alt class="img img-responsive"></a>
                        </div>
                    </div>
                </div> <!-- end row -->
            </div> <!-- end container -->
