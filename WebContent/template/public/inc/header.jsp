...
<!-- Mirrored from themeinnovation.com/demo/html/land-care/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Mar 2017 08:33:53 GMT -->
<head>
    <!-- Meta Tags -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Land care Responsive HTML Template">
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <!-- Start header -->
        <header id="header" class="site-header header-style-one">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col col-xs-6">
                            <p>Welcome to our <span>LendCare template</span></p>
                        </div>
                        <div class="col col-xs-6">
            ...
            <nav class="navigation navbar navbar-default" id="main-nav">
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse navbar-right">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="sub-menu">
                                <a href="#">Dự Án</a>
                                <ul>
                                    <li><a href="gallery.html">Tất cả</a></li>
                                    <li><a href="gallery-grid.html">Công nghệ</a></li>
                                    <li><a href="gallery-title.html">Nông nghiêp</a></li>
                                    <li><a href="gallery-masonry.html">Công Nghiệp</a></li>
                                    <li><a href="gallery-masonry.html">Công Nghiệp</a></li>
                            ...
                            <li class="sub-menu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="about.html">Thành Viên</a></li>
                                    <li><a href="about-style2.html"></a></li>
                                </ul>
                            </li>
                            ...
                            <li class="sub-menu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="contact-s2.html">Contact style 2</a></li>
                                </ul>
                            </li>
							<li class="sub-menu">
                                <a href="#">Tài Khoản</a>
                                <ul>
                                    ...
                                    <li><a href="service-s2.html">Log in</a></li>
                                </ul>
                            </li>
                        </ul>
