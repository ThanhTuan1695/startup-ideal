    ...
    <%@ include file="/templates/public/inc/header.jsp" %>
        ...
        <section class="page-title">
            <div class="container">
                <div class="title">
                    <div class="icon">
                        <img src="<%=request.getContextPath()%>/templates/public/images/page-title/icon-2.png" alt>
                    </div>
                    <h1>Blog Details</h1>
                    <ol class="breadcrumb">
                      <li><a href="#">Home</a></li>
                        ...
                        <div class="post">
                            <div class="entry-header">
                                <div class="entry-media">
                                    <img src="<%=request.getContextPath()%>/templates/public/images/news/classic/img-1.jpg" alt class="img img-responsive">
                                </div>
                                <ul class="entry-meta">
                                    <li>
                            ...
                            <div class="entry-details">
                                ...
                                <div class="entry-content">
                                    ...
                                    <div class="gallery-post">
                                        <div class="gallery">
                                            <div>
                                                <img src="<%=request.getContextPath()%>/templates/public/images/news/details/img-1.jpg" alt class="img img-responsive">
                                            </div>
                                            <div>
                                                <img src="<%=request.getContextPath()%>/templates/public/images/news/details/img-2.jpg" alt class="img img-responsive">
                                            </div>
                                        </div>
                                    ...
                                    <div class="article">
                                        <div class="comment-meta">
                                            <div class="comment-author-metadata">
                                                <img src="<%=request.getContextPath()%>/templates/public/images/news/comments/img-1.png" alt="">
                                                <div class="metadata">
                                    ...
                                    <ol>
                                        <li>
                                            <div class="article">
                                                <div class="comment-meta">
                                                    <div class="comment-author-metadata">
                                                        <img src="<%=request.getContextPath()%>/templates/public/images/news/comments/img-2.png" alt="">
                                                        <div class="metadata">
                                                            <h6 class="author"><a href="#">Admin says</a></h6>
                                                            <span class="date">April 5, 2016 AT 12:45 AM</span> 
                                                        </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="post-image">
                                            <img src="<%=request.getContextPath()%>/templates/public/images/news/thumb/img-1.jpg" alt class="img img-responsive">
                                        </div>
                                    ...
                                    <li>
                                        <div class="post-image">
                                            <img src="<%=request.getContextPath()%>/templates/public/images/news/thumb/img-2.jpg" alt class="img img-responsive">
                                        </div>
                                        <div class="post-details">
                                            <h5><a href="#">Now were up in the big leagues getting</a></h5>
                                            <span class="date">May 20, 2016</span>
                                    ...
                                    <li>
                                        <div class="post-image">
                                            <img src="<%=request.getContextPath()%>/templates/public/images/news/thumb/img-3.jpg" alt class="img img-responsive">
                                        </div>
                                        <div class="post-details">
                                            <h5><a href="#">Now were up in the big leagues getting</a></h5>
                                            <span class="date">May 20, 2016</span>
