<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ include file="/templates/public/inc/header.jsp" %>
        ...
        <section class="gallery-grid-section full-width-project-gallery section-padding">
            <div class="container">
                ...
                <div class="gallery-content">
                    ...
                    <div class="grid-wrapper gallery-popup">
                        ...
                        <div class="grid garden-care snow-removal">
                            <div class="grid-inner">
                                <a href="images/grid-gallery/big-photo/img-7.jpg">
                                    <div class="img-holder">
                                        <img src="images/grid-gallery/img-7.jpg" alt class="img img-responsive">
                                    </div>
                                    <div class="hover-text">
                                        <div>
                                            <h4>Title here</h4>
                        ...
                        <div class="grid garden-care plantion">
                            <div class="grid-inner">
                                <a href="images/grid-gallery/big-photo/img-8.jpg">
                                    <div class="img-holder">
                                        <img src="images/grid-gallery/img-8.jpg" alt class="img img-responsive">
                                    </div>
                                    <div class="hover-text">
                                        <div>
                                            <h4>Title here</h4>
                        ...
                        <div class="grid snow-removal plantion">
                            <div class="grid-inner">
                                <a href="images/grid-gallery/big-photo/img-1.jpg">
                                    <div class="img-holder">
                                        <img src="images/grid-gallery/img-9.jpg" alt class="img img-responsive">
                                    </div>
                                    <div class="hover-text">
                                        <div>
                                            <h4>Title here</h4>
